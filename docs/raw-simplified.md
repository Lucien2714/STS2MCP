...
|---|---|---|
| `menu` | Main menu, menu submenu (incl. multiplayer host/join/load lobby), character select, custom-run setup, or a blocking FTUE/tutorial/popup that can also appear mid-run | `menu_select` |
